...
# 4. Melakukan Split Data (Time-Based Split)
# Kita latih model menggunakan data tahun 2021-2024 dan diuji menggunakan data tahun 2025
...
# 6. Model Pipeline (Menggunakan Regulasi Mencegah Overfitting)
...
# 7. Evaluasi Overfitting (Perbandingan Train vs Test Score)
...
if (r2_train - r2_test) > 0.05:
    print("⚠️ PERINGATAN: Selisih skor > 5%. Model mungkin mengalami overfitting ringan.")
else:
